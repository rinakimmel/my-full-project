...
/**
 * PostItem
 * Macro: מציג פוסט בודד, מאפשר עריכת כותרת אינליין ומחיקה אם המשתמש הוא הבעלים.
 * Props:
 *  - post, isPostOwner, deletePost, updatePost, currentUserEmail
 * State:
 *  - editingTitle: אובייקט זמני לעריכת כותרת
 */
import { useState } from "react";
import { Link, useParams } from "react-router-dom";
